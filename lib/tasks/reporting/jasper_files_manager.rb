class JasperFilesManager
  class << self
    CORPORATE_IDENTITIFY_FOLDER = 'corporate_identity'.freeze
    CORPORATE_IDENTITIFY_XML_FILE = 'reporting_style.xml'.freeze

    JASPER_XML_NAMESPACE = 'http://jasperreports.sourceforge.net/jasperreports'.freeze
    COMMENT_XPATH = '//comment()'.freeze
    TEMPLATE_XPATH = 'xmlns:template'.freeze
    JASPER_TEMPLATE_XPATH = '//jasperTemplate'.freeze
    STYLES_XPATH = 'xmlns:style'.freeze
